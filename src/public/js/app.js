...
check01.addEventListener("click",handleTramsForm);
...
zoomIn4.addEventListener("click",handleZoomIn4);
 ...
 // 의사표현 
  ...
  let inputImo = document.querySelector("#test") 
 ...
 /**
  ...
  function captureScreen() {
    navigator.mediaDevices.getDisplayMedia({
      ...
      setTimeout(()=> {captureScreenDelay(capture, track)} , 300);
